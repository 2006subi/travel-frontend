...
const TourDetails = (tour) => {
  ...
  const { data: tourDetails } = useFetch(`https://travel-backend-7k8o.onrender.com/${id}`);

  const {data:tourReviews}=useFetch(`https://travel-backend-7k8o.onrender.com/${id}`); 
  ...
  const handleSubmit = async(e) => {
    ...
    await axios.post(`https://travel-backend-7k8o.onrender.com/${id}`,{username,reviewText,rating,time},{
      headers:{
